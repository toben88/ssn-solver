          ...
          Expanded(
            child: isSmallScreen
                ? Column(
                    ...
                    children: [
                      // Selected provisions (top on mobile)
                      Expanded(
                        flex: 2,
                      ...
                      // Deficit visualization (bottom on mobile)
                      Expanded(
                        flex: 3,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
                ...
                : Row(
                    crossAxisAlignment: CrossAxisAlignment.stretch,
                    children: [
                      // Selected provisions (left side on desktop, top on mobile)
                      Expanded(
                        flex: 2,
                        child: DragTarget<Provision>(
                          onAccept: (provision) {
                      ...
                      // Deficit visualization (right side on desktop, bottom on mobile)
                      Expanded(
                        flex: 3,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.stretch,
